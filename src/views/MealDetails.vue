<template>
    <div class="max-w-[800px] mx-auto p-8">
        <h1 class="text-4xl font-bold mb-5 text-orange-400">
            {{ meal.strMeal }}
        </h1>
        <img
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div class="mt-4">
                ...
                <a
                    :href="meal.strSource"
                    target="_blank"
                    class="ml-3 px-3 py-2 rounded border-2 border-transparent text-indigo-600 hover:text-indigo-400 transition-colors"
                >
